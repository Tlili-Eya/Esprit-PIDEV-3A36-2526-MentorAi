...
class SortieAI
{
    ...
    #[ORM\Column(enumType: StatutSortie::class, options: ["default" => StatutSortie::Nouveau])]
    private StatutSortie $statut = StatutSortie::Nouveau;

    #[ORM\Column(enumType: Cible::class)]
    private Cible $cible;

    #[ORM\Column(enumType: TypeSortie::class)]
    private TypeSortie $typeSortie;

    #[ORM\Column(enumType: Criticite::class)]
    private Criticite $criticite;

    #[ORM\Column(enumType: CategorieSortie::class)]
